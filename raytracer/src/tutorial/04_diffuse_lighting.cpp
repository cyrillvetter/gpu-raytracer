...
const std::string NAME = "04 - Diffuse Lighting";
...
int main() {
    ...
    std::array<Sphere, 5> spheres = {
        Sphere{ {  1.6, 0.45,  1.4 }, 0.45, { 0.20, 0.36, 0.40, 1.0 } },
        Sphere{ {  0.6, 0.30,  0.0 }, 0.30, { 1.00, 0.95, 0.69, 1.0 } },
        Sphere{ { -1.2, 0.20,  0.6 }, 0.20, { 0.88, 0.62, 0.24, 1.0 } },
        Sphere{ { -0.2, 0.25, -0.4 }, 0.25, { 0.62, 0.17, 0.17, 1.0 } },
        Sphere{ { -0.9, 0.10, -0.5 }, 0.10, { 0.33, 0.04, 0.06, 1.0 } },
    };
    ...
    engine::Shader shader("shaders/tutorial/04_diffuse_lighting.spv");
